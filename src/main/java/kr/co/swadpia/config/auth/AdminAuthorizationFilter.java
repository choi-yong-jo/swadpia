...
import static kr.co.swadpia.config.auth.JwtConstants.ADMIN_JWT_SECRET;
...
public class AdminAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, @NotNull HttpServletResponse response, @NotNull FilterChain filterChain) throws ServletException, IOException {
        ...
        if (servletPath.startsWith("/api/admin/")) {

            if ( servletPath.equals("/api/admin/auth/login")  ) {
                ...
                try {
                    ...
                    AdminSessionDTO adminSessionDTO = (AdminSessionDTO) adminAuthService.loadUserByUsername(email);
                    UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(adminSessionDTO, null, authorities);
